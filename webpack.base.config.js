...
module.exports = {
  ...
  entry:[
    ...
    path.resolve(__dirname,'src/assets/js/libs/zepto.js'),
    path.resolve(__dirname,'src/assets/js/libs/touch.js'),
    path.resolve(__dirname,'src/assets/js/libs/iscroll-lite.js'),
